...
public class TargetIndicator : MonoBehaviour
{
    ...
    public void SetImageAndColors(Color color, Sprite inScreenImage, Sprite offScreenImage)
    {
        TargetIndicatorImage.sprite = inScreenImage;
        OffScreenTargetIndicator.sprite = offScreenImage;

        TargetIndicatorImage.color = color;
        Color offScreenColor = color;
        offScreenColor.a = 0f;
        OffScreenTargetIndicator.color = offScreenColor;
    }
